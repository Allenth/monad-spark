...
截至 2026-09-05：仓库已建立，MOJO 助手已绑定；本仓库只有文档，没有产品代码、合约、已部署网站或参赛提交。资料整理不代表产品已完成。
...
尚未选择脚手架或包管理器，无可用的安装、启动、构建或测试命令。不要把其他模板的命令当成本项目已验证命令。

## 架构与部署

Monad 是已提出的底层链方向；前端、后端、文件存储、钱包和电子签名供应商均未定版。没有演示网址、合约地址或部署环境。下一步先明确签约场景及比赛范围。
